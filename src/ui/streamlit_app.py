...
# ---------------------------------------------------------------- Streamlit UI
st.set_page_config(page_title="FastAPI Changelog Q&A", page_icon="⚡", layout="centered")

st.title("⚡ FastAPI Changelog Q&A")
st.caption("Pesquise features, breaking changes e novidades do FastAPI por versão — com citação do release notes.")
...
st.divider()
st.caption(
    "RAG sobre o changelog oficial do FastAPI. "
    "Respostas com citação de versão. Cache semântico + routing cheap-first ativo."
)
